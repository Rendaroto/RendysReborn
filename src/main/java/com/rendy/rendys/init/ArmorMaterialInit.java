...
public enum ArmorMaterialInit implements ArmorMaterial {
    COPPER("copper", 8, new int[]{ 8, 10, 8, 7}, 10,SoundEvents.ARMOR_EQUIP_IRON, 1f, 0.1f, () -> Ingredient.of(Items.COPPER_INGOT)),
    EMERALD("emerald", 43, new int[]{ 4, 9, 7, 4 }, 25,SoundEvents.ARMOR_EQUIP_DIAMOND, 2.2f, 0.2f, () -> Ingredient.of(Items.COPPER_INGOT)),
