...
public class ItemInit {
    ...
    public static final DeferredItem<Item> REINFORCED_NETHERITE_TEMPLATE = ITEMS.register("reinforced_netherite_upgrade_smithing_template",() -> new Item(new Item.Properties().stacksTo(32).fireResistant()));
    public static final DeferredItem<Item> SUPER_NETHERITE_TEMPLATE = ITEMS.register("super_netherite_upgrade_smithing_template",() -> new Item(new Item.Properties().stacksTo(32).fireResistant()));
